...
public class EMASmoothing {
  ...
  private final Deque<com.ahmad.mldetectkotlin.classification.ClassificationResult> window;
  ...
  public com.ahmad.mldetectkotlin.classification.ClassificationResult getSmoothedResult(com.ahmad.mldetectkotlin.classification.ClassificationResult classificationResult) {
    ...
    for (com.ahmad.mldetectkotlin.classification.ClassificationResult result : window) {
      allClasses.addAll(result.getAllClasses());
    }

    com.ahmad.mldetectkotlin.classification.ClassificationResult smoothedResult = new com.ahmad.mldetectkotlin.classification.ClassificationResult();
